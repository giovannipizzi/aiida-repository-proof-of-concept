...
@click.option('-D', '--db-name', required=True, help='DB database name (IT WILL BE DROPPED! USE A TEST DB).')
@click.option('-P', '--db-password', required=True, help='DB password.')
@click.option('-r', '--repository-folder', required=True, help='Repository folder of AiiDA to import (will not be modified).')
